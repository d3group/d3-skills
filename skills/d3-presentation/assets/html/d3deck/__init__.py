...
"""
from .deck import (meta, titleslide, agenda, section, onecol, twocol, twocoltakeaway, slide, thankyou,
...
__all__ = ['meta', 'titleslide', 'agenda', 'section', 'onecol', 'twocol', 'twocoltakeaway', 'slide', 'thankyou',
           'appendix', 'backuphome', 'mark', 'jump', 'link', 'css', 'build', 'D',
