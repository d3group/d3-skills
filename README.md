...
| [d3-presentation](skills/d3-presentation/) | 1.1.0 | Presentations as LaTeX Beamer PDFs or interactive HTML decks with step builds | Beamer theme, HTML deck engine, overflow audit |
